...
const operationBtnSqrt = document.querySelector('[operation-sqrt]');
const equalsBtn = document.querySelector('[equals]');
const clearBtn = document.querySelector('[delete]');
const allClearBtn = document.querySelector('[all-clear]');
const prevOperandTxtEl = document.querySelector('[previous-operand]');
const curOperandTxtEl = document.querySelector('[current-operand]');
